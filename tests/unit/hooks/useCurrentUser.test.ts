...
describe("useCurrentUserProfile", () => {
  ...
  it("maps current user data and resolves document status", async () => {
    const user = {
      ...
      name: "N",
      verified: true,
      address: { street: "s", number: "10", city: "c", zip: "z", country: "ct" },
    } as const;
  ...
  it("parses numeric address number into a number field", async () => {
    const user = {
      ...
      userType: "PROFESSOR",
      verified: true,
      address: { street: "s", number: "123", city: "c", zip: "z", country: "ct" },
    } as const;
  ...
  it("handles non-numeric address number by leaving number undefined", async () => {
    const user = {
      ...
      userType: "PROFESSOR",
      verified: false,
      address: { street: "s", number: "abc", city: "c", zip: "z", country: "ct" },
    } as const;
