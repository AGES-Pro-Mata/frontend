...
describe("PasswordInput", () => {
  ...
  it("marks the field invalid after blur when required and empty, then clears once filled", async () => {
    ...
    rerender(
      <PasswordInput required placeholder="Digite" value="filled" className="custom-class" />,
    );
  ...
  it("forwards change handler and displays provided error message", () => {
    ...
    render(<PasswordInput placeholder="Digite" onChange={handleChange} error="Senha inválida" />);
