        ...
        <div className="md:w-2/3 md:items-start flex flex-col w-full items-center">
          ...
          <div className="md:flex-row md:items-start flex flex-col w-full mt-5 items-center">
            <div className="w-1/2 gap-4">
              <Typography variant="body_light">Centro de Pesquisas PRÓ-MATA</Typography>
              <Typography variant="body_light">CIDADE</Typography>
            </div>
            <div className="w-1/2 gap-4">
              <Typography variant="body_light">Telefone: (XX) XXXX-XXXX</Typography>
              <Typography variant="body_light">E-mail: contato@pro-mata.org</Typography>
            </div>
          </div>
        </div>
      </div>
