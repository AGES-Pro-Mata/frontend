  ...
  const button = (
    <Comp
      ...
      className={cn(
        ...
        "data-[active=true]:bg-contrast-green/10 data-[active=true]:text-contrast-green data-[active=true]:[&_svg]:text-contrast-green data-[active=true]:[&_p]:text-contrast-green",
        className,
      )}
      {...props}
    />
...
export function SidebarButton({ icon, label, to }: SidebarButtonProps) {
  ...
  return (
    <SidebarMenuItem>
      <SidebarMenuButton size="lg" asChild isActive={!!matchRoute({ to, fuzzy: true })}>
        <Link to={to}>
